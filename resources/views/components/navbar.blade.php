            ...
            <div class="hidden md:flex items-center gap-1">
                ...
                @else
                    ...
                    @if (Route::has('register'))
                        <a href="{{ route('register') }}" class="nav-link-liquid px-4 py-2 rounded-lg text-sm font-bold text-gray-800 transition-all duration-300 {{ request()->routeIs('register') ? 'active' : '' }}">Daftar</a>
                    @endif
                @endauth
            </div>
    ...
    <div id="mobile-menu" class="hidden md:hidden bg-white/95 backdrop-blur-lg border-t border-gray-100">
        <div class="px-4 py-6 space-y-1">
            ...
            @else
                ...
                @if (Route::has('register'))
                    <a href="{{ route('register') }}" class="block mx-4 mt-2 px-5 py-3 rounded-full text-center text-base font-bold border-2 border-primary-600 transition-all duration-300 {{ request()->routeIs('register') ? 'bg-primary-600 text-white' : 'text-primary-600 hover:bg-primary-50' }}">📝 Daftar</a>
                @endif
            @endauth
        </div>
    </div>

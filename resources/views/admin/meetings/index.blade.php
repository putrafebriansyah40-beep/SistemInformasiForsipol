    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="mb-4 flex flex-col sm:flex-row sm:justify-between sm:items-center gap-3">
                <p class="text-gray-600 text-sm sm:text-base">Daftar rapat dan rekap kehadiran anggota</p>
                <a href="{{ route('admin.meetings.create') }}" class="px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 transition shadow-sm text-sm whitespace-nowrap text-center">
                    + Jadwalkan Rapat
                </a>
            </div>

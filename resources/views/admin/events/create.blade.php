                ...
                <form action="{{ route('admin.events.store') }}" method="POST">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5 mb-5">
                        <div>
                            ...
                            <x-text-input id="waktu_pelaksanaan" class="block mt-1 w-full" type="datetime-local" name="waktu_pelaksanaan" :value="old('waktu_pelaksanaan')" required />
                    ...
                    <div class="mb-6">
                        ...
                        <textarea id="deskripsi" name="deskripsi" rows="4" class="block mt-1 w-full border-gray-200 bg-gray-50/50 backdrop-blur-sm text-gray-900 focus:border-primary-500 focus:ring-primary-500 focus:bg-white rounded-xl shadow-sm transition duration-200 px-4 py-3" placeholder="Detail kegiatan...">{{ old('deskripsi') }}</textarea>

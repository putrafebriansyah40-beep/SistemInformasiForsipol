                    ...
                    <form action="{{ route('admin.events.update', $event) }}" method="POST" class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="md:col-span-2">
                                ...
                                <input type="text" name="nama_kegiatan" id="nama_kegiatan" value="{{ old('nama_kegiatan', $event->nama_kegiatan) }}" required
                            ...
                            <div class="md:col-span-2">
                                ...
                                <input type="text" name="lokasi" id="lokasi" value="{{ old('lokasi', $event->lokasi) }}" placeholder="Contoh: Gedung A / Link Zoom"
                                       class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500 text-sm">
                            ...
                            <div class="md:col-span-2">
                                ...
                                <textarea name="deskripsi" id="deskripsi" rows="4"
                                          class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500 text-sm"
                                          placeholder="Detail kegiatan...">{{ old('deskripsi', $event->deskripsi) }}</textarea>

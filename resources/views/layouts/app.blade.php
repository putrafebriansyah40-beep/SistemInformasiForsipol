...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="bg-gray-50 text-gray-800 antialiased selection:bg-primary-500 selection:text-white">
        <div class="min-h-screen relative">
            <!-- Background Decoration (Optional, similar to homepage) -->
            <div class="absolute top-0 right-0 -z-10 w-full h-96 bg-gradient-to-b from-primary-50/50 to-transparent"></div>
